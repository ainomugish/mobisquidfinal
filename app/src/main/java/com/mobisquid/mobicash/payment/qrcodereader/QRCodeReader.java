...
import com.mobisquid.mobicash.payment.activities.WendorDetailsActivity;
  ...
  */
   /* @Override
        ...
        if (result != null) {
            ...
            if (result.getContents() == null) {
                ...
                try {
                    ...
                    Toast.makeText(context, result.getContents().toString(), Toast.LENGTH_LONG).show();
    ...
    public void handleResult(Result rawResult) {
        ...
        if (result != null) {
            Gson gson = new Gson();
            DataModel dataModel = gson.fromJson(result, DataModel.class);
            if (dataModel != null) {
                Intent intent = new Intent(context, WendorDetailsActivity.class);
                intent.putExtra(WendorDetailsActivity.KEY_WENDOR, dataModel);
