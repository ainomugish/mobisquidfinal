 ...
 */
public class Registration_five extends Fragment  {
    Vars vars;
    View rootview;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        rootview = inflater.inflate(R.layout.fragment_registration_five, container, false);
        ...
        string_id_photo.setText(Html.fromHtml(getString(R.string.proof_residence)));

        if(stored.getResidencephoto().equalsIgnoreCase("resid")){
            Picasso.with(vars.context).load(vars.server_mb + "proofresidence.jpg".trim())
                    .error(R.color.colorAccent)
                    .placeholder(R.color.colorAccent)
                    .into(my_id_photo);

        }else{
            imagepath =stored.getResidencephoto();
            my_id_photo.setImageURI(Uri.parse(new File(stored.getResidencephoto()).toString()));
        }
        ...
        nextimage.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if(imagepath==null){
                    ...
                    stored.setResidencephoto(imagepath);
                    stored.save();
                    Registeruser();
    ...
    public void onResume() {
        ...
        toolbar.setTitle("Proof of residence photo  6/6");
        try {
            if (imagepath != null) {
                TempStore filesstore = TempStore.findById(TempStore.class, 1);
                String[] params = {encodedIDString, encodedIDStringResidence, encodedFaceString};
                String[] values = {filesstore.getIdImage(), filesstore.getResidencephoto(), filesstore.getFaceImage()};
    ...
    public void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        switch (requestCode) {
            ...
            case PICK_FROM_CAMERA:
                try{
//
                    Utils.cropimage(getActivity(), "residence", Utils.decodeUri(mImageCaptureUri, getActivity()), my_id_photo, new Utils.StringCallback() {
                        @Override
        ...
        new SweetAlertDialog(getActivity(), SweetAlertDialog.WARNING_TYPE)
                ...
                .setConfirmClickListener(new SweetAlertDialog.OnSweetClickListener() {
                    ...
                    public void onClick(SweetAlertDialog sweetAlertDialog) {
                        ...
                        String mobile;
                        if(vars.country_code.length()==2){
                            String num = storereg.getMobile().substring(2);
                            mobile = "0"+num;
                        }else if(vars.country_code.length()==1){
                            String num = storereg.getMobile().substring(1);
                            mobile = "0"+num;
                        }else{
                        ...
                        String[] parameters={"mobile","firstName","lastName","pinCode","password",
                                ...
                                "location","idtype","tempresnr","idexpiration ","province","city","faceImage",
                                "idImage","residencephoto"};
                        String[] values={ mobile, storereg.getFirstName(),storereg.getSecondname(),
                                ...
                                storereg.getNokRelation(),imei.getDeviceId(),"South Africe",storereg.getIdtype(),
                                storereg.getTempresnr(),storereg.getIdexpiration(),storereg.getProvince(),
                                storereg.getCity(),encodedFaceString, encodedIDString,encodedIDStringResidence};
